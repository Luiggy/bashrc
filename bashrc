# .bashrc
#  SETUP CONSTANTS
#  Bunch-o-predefined colors. This makes reading code easier than escape
#  sequences.
...
echo "Hola $USER espero que tengas un buen dia"| cowsay
...
#Creating a separate alias file:
